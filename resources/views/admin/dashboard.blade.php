            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form action="{{ route('admin.lesson.delete', ['id' => $lesson->getId()]) }}" method="POST">
                            @csrf
                            @method('DELETE')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('order.show', ['id' => $order->getId()]) }}" class="btn btn-sm btn-primary">{{ __('messages.view_order') }}</a>
                        </div>
                    </div>
                    <hr>
                    @endforeach
...
<div class="card">
    ...
    <div class="card-body">
        <div class="text-center mt-4">
            <a href="{{ route('admin.stock.index') }}" class="btn btn-secondary">{{ __('messages.stock_msg') }}</a>
        </div>
    </div>
